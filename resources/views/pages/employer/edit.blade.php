        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">@lang('variables.employers.forms.edit_title')</div>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('employers.edit', ['id' => $employer->id]) }}">
                            ...
                            <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="gender" value="m" {{ ( old('gender', $employer->gender) == 'm') ? 'checked' : '' }}> @lang('variables.gender.male')
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="gender" value="w" {{ ( old('gender', $employer->gender) == 'w') ? 'checked' : '' }}> @lang('variables.gender.female')
